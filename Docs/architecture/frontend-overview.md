...
> *Server vs. Client*: A file becomes a **Client Component** only if it contains the directive `'use client'` at the top. Those run in the browser and can use React state, effects, etc.
