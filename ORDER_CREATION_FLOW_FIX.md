...
3.  **Deploy:** This will solve the 500 error for *all* future users, even if registration glitches occur.
...
*   **🛡️ SAFETY CHECK (Lazy Creation):**
    *   *Check:* `doesBuyerProfileExist(User.id)?`
    *   *If NO:* **Create it now!** (Don't fail).
        ```java
...
*Status: **ACTIVE** & Deployed locally.*
